...
class WalletTransferApprovedEvent implements ShouldBeLogged,LoggableEventPayloadInterface
{
    ...
    {
        return [
            'wallet_transfer_request_id' => $this->request->getKey(),
        ];
    }

    public static function fromLoggablePayload(array $payload): static
    {
        $request = WalletTransferRequest::findOrFail($payload['wallet_transfer_request_id']);
