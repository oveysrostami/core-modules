...
class JibitClientDriver
{
     ...
     */
    public function paymentRequest($amount, $referenceNumber, $userIdentifier, $callbackUrl, $currency = 'IRR', $description = null, $additionalData = null): mixed
    {
        $this->generateToken();
        ...
        $data = [
            ...
            'payerMobileNumber'=>$userIdentifier,
     ...
     * @throws PurchaseFailedException
     */
    private function callCurl(string $url, $arrayData, bool $haveAuth = false, int $try = 0, string $method = 'POST'): mixed
    {
        $data = $arrayData;
