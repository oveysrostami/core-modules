    ...
    */
    'stubs' => [
        ...
        'files' => [
            ...
            'lang/fa/messages' => 'lang/fa/message.php',
            'lang/en/messages' => 'lang/en/message.php',
            'lang/fa/attributes' => 'lang/fa/attributes.php',
            'lang/en/attributes' => 'lang/en/attributes.php',
            'command/install' => 'app/Console/Install.php',
            'command/setup' => 'app/Console/Setup.php'
        ...
        'replacements' => [
            ...
            'scaffold/permission' => ['STUDLY_NAME'],
            'command/install' => ['LOWER_NAME','STUDLY_NAME'],
            'command/setup' => ['LOWER_NAME','NAMESPACE','STUDLY_NAME'],
            'composer' => [
                'LOWER_NAME',
                'STUDLY_NAME',
                'VENDOR',
