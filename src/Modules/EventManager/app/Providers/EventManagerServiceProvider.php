...
use Modules\EventManager\Console\EventManagerInstall;
use Modules\EventManager\Console\EventManagerSetup;
...
class EventManagerServiceProvider extends ServiceProvider
{
    ...
    {
        $this->commands([
            EventManagerInstall::class,
            EventManagerSetup::class,
        ]);
    }
